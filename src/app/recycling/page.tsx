...
{/* <TextBlock
        heading={{ text: 'Нашата Мисия', fontSize: 36, color: 'green', textFont: 'sans', fontWeight: 700, margin: '20px 30px 20px 30px' }}
        subHeading={{ text: 'M-Texx се стреми да окаже положително въздействие; настоящата ни цел е да утроим процента на рециклирания текстил от 2% на 6% до 2030 г. Ние ще предоставим безплатни услуги за рециклиране на текстил на домакинства и организации в България и да насърчим за намаляване на използването, преизползването и рециклирането, чрез образование, с акцент върху ангажирането на младежите в училищата.',
         fontSize: 24, textFont: 'serif', width: '100%', padding: '2', margin: '10px auto' }}
      /> */}
...
{/* <GridBlock 
  ...
  blocks={[
    {
      heading: { text: 'Hello World 1', fontSize: 32 },
      subHeading: { text: 'Subheading text 1', fontSize: 24 },
      description: { text: 'This is a description 1.', fontSize: 16 },
      unorderedList: { items: ['Item 1', 'Item 2'], fontSize: 16 }
    },
    {
      heading: { text: 'Hello World 1', fontSize: 32 },
      subHeading: { text: 'Subheading text 1', fontSize: 24 },
...
{/* <TextBox 
        header="Нашата мисия" 
        subheader=""
        description={`"M-Texx се стреми да окаже положително въздействие; \n
        Настоящата ни цел е да утроим процента на рециклирания текстил от 2% на 6% до 2030 г. \n
        Ние ще предоставим безплатни услуги за рециклиране на текстил на домакинства и организации \n
        в България и да насърчим за намаляване на използването, преизползването и рециклирането, \n
        чрез образование, с акцент върху ангажирането на младежите в училищата."`}
        headerProps={{
          fontSizeBase: '2rem',
          fontSizeSm: '1.4rem',
          fontSizeMd: '1.8rem',
...
<TextBox 
        header="Жизненият цикъл на текстила" 
        subheader="Ние работим с нашите партньори, за да поддържаме текстила в затворен цикъл на рециклиране, за да помогнем на:"
        description=""
        headerProps={{
          fontSizeBase: '2rem',
          fontSizeSm: '1.4rem',
